...
public class Utils 
{
     ...
     */
    public static void enviarMensaje(Agent agent, String tipo, Object objeto, String ontologia, int tipo_mensaje)
    {
        ...
        try
        {
            if(dfd!=null)
            {
            	ACLMessage aclMessage = new ACLMessage(tipo_mensaje);
    ...
    //Envía un objeto desde el agent a un agente específico
    public static void enviarMensajeDirecto(Agent agent, Object objeto, String ontologia, AID agentedirecto, int tipo_mensaje)
    {
        
            	ACLMessage aclMessage = new ACLMessage(tipo_mensaje);
            	aclMessage.addReceiver(agentedirecto); // enviamos la respuesta a quien realizo la petición
            	aclMessage.setOntology(ontologia);
                //el lenguaje que se define para el servicio
                aclMessage.setLanguage(new SLCodec().getName());
                //el mensaje se transmita en XML
